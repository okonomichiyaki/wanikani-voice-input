...
var _toHiraganaJs = require("./candidates/to_hiragana.js");
var _basicDictionaryJs = require("./candidates/basic_dictionary.js");
var _suruVerbsJs = require("./candidates/suru_verbs.js");
var _repeatingJs = require("./candidates/repeating.js");
var _fuzzyVowelsJs = require("./candidates/fuzzy_vowels.js");
var _multipleJs = require("./candidates/multiple.js");
var _numeralsJs = require("./candidates/numerals.js");
function onStart() {
    const context = _wanikaniJs.getContext();
    if (context.page === "review" || context.page === "lesson" || context.page === "quiz") startListener();
    if (context.page === "entry" && true) startListener();
}
function handleSpeechRecognition(transformers, state, commands, raw, final) {
    ...
    if (state === "Ready") {
        const context = _wanikaniJs.getContext();
        const result = (0, _flashcardsJs.checkAnswer)(context, transformers, raw);
...
function contextHasChanged(prev) {
    ...
    if (prev.prompt !== curr.prompt || prev.category !== curr.category || prev.type !== curr.type) return curr;
    else return null;
}
function startListener() {
    ...
    const transformers = [
        new (0, _toHiraganaJs.ToHiragana)(),
        new (0, _basicDictionaryJs.BasicDictionary)(dictionary),
        new (0, _suruVerbsJs.SuruVerbs)(dictionary),
        new (0, _repeatingJs.RepeatingSubstring)(),
        new (0, _multipleJs.MultipleWords)(dictionary),
        new (0, _numeralsJs.Numerals)()
    ];
    const lang = _wanikaniJs.getLanguage();
    const recognition = (0, _recognitionJs.createRecognition)(lang, function(raw, final) {
        (0, _liveTranscriptJs.logTranscript)((0, _settingsJs.getSettings)(), raw);
        let outcome = handleSpeechRecognition(transformers, state, commands, raw, final);
        (0, _liveTranscriptJs.logTranscript)((0, _settingsJs.getSettings)(), outcome.transcript);
...
if (unsafeWindow.wkof) {
    ...
    (0, _settingsJs.initializeSettings)(wkof, onStart);
} else onStart();

},{"./flashcards.js":"fZzWP","./recognition.js":"lBAA0","./wanikani.js":"7jgsw","./settings.js":"4remP","./live_transcript.js":"leaCl","./dict.js":"68Yu8","./candidates/to_hiragana.js":"e8LfV","./candidates/basic_dictionary.js":"1ZWA5","./candidates/suru_verbs.js":"l85cN","./candidates/repeating.js":"emeTB","./candidates/fuzzy_vowels.js":"d7xuY","./candidates/multiple.js":"eJg4y","./candidates/numerals.js":"ejBbU"}],"fZzWP":[function(require,module,exports) {
...
function normalize(s) {
    ...
    return (0, _wanakana.toHiragana)(n);
}
...
function checkAnswer(context, transformers, raw) {
    ...
    for (const key of keys){
        ...
        const newCandidates = [];
        for (const t of ts)for (const c of candidates)newCandidates.push(...t.getCandidates(c.data));
...
},{"./wanikani.js":"7jgsw","./util.js":"cgcsT","wanakana":"ewinz","js-levenshtein":"7Ee4H","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7jgsw":[function(require,module,exports) {
...
function getCategory() {
    ...
    if (document.location.href.match("vocabulary")) return "vocabulary";
    if (document.location.href.match("kanji")) return "kanji";
    if (document.location.href.match("radicals")) return "radical";
    return null;
}
...
function getType() {
    ...
    if (document.location.href.match("vocabulary")) return "reading";
    if (document.location.href.match("kanji")) return "reading";
    if (document.location.href.match("radicals")) return "name";
    return null;
}
...
function getContext() {
    ...
    let page = "";
    if (document.location.href.match("review")) page = "review";
    if (document.location.href.match("lesson")) page = "lesson";
    if (document.location.href.match("quiz")) page = "quiz";
    if (document.location.href.match("vocabulary|radicals|kanji")) page = "entry";
...
function getEntrySubjects() {
    ...
    if (!reading) reading = document.querySelector(Selectors.EntryVocabReading);
    if (!prompt || !meaning || !reading) return null;
    const result = {};
    const subject = {};
    subject.meanings = [
        meaning.textContent
    ...
    subject.readings = [
        {
            reading: reading.textContent.trim()
        }
    ];
    result[meaning.textContent] = [
        subject
    ];
    result[subject.readings[0]] = [
        subject
    ];
    result[prompt] = [
        subject
    ...
    if (alts) {
        ...
        for (const m of meanings)result[m] = [
            subject
        ];
...
function getSubjects() {
    ...
    if (!script) return getEntrySubjects();
...
},{}],"lBAA0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./settings.js":"4remP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4remP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "logTranscript", ()=>logTranscript);
...
function logTranscript(settings, text) {
    ...
    for(let i = start; i >= end && i >= 0; i--)clearTranscriptWith(`transcript-${i}`);
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e8LfV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ToHiragana", ()=>ToHiragana);
var _wanakana = require("wanakana");
class ToHiragana {
    ...
    getCandidates(raw) {
        ...
        if ((0, _wanakana.isJapanese)(raw)) {
            const hiragana = (0, _wanakana.toHiragana)(raw, {
                convertLongVowelMark: true
            });
            candidates.push({
                "type": "hiragana",
...
},{"wanakana":"ewinz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1ZWA5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BasicDictionary", ()=>BasicDictionary);
var _wanakana = require("wanakana");
...
class BasicDictionary {
    ...
    getCandidates(raw) {
        if (!(0, _wanakana.isJapanese)(raw)) return [];
        const candidates = [];
        const hiragana = (0, _wanakana.toHiragana)(raw);
...
},{"wanakana":"ewinz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l85cN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SuruVerbs", ()=>SuruVerbs);
var _wanakana = require("wanakana");
var _basicDictionaryJs = require("./basic_dictionary.js");
class SuruVerbs {
    constructor(dictionary){
        this.order = 0;
        this.basicDictionary = new (0, _basicDictionaryJs.BasicDictionary)(dictionary);
    }
    getCandidates(raw) {
        const hiragana = (0, _wanakana.toHiragana)(raw);
        const candidates = [];
        if (hiragana.endsWith("する")) {
            ...
            for (let r of readings)candidates.push({
                type: "する",
                data: r + "する"
            });
        }
...
},{"wanakana":"ewinz","./basic_dictionary.js":"1ZWA5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"emeTB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "findRepeatingSubstring", ()=>findRepeatingSubstring);
parcelHelpers.export(exports, "RepeatingSubstring", ()=>RepeatingSubstring);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d7xuY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FuzzyVowels", ()=>FuzzyVowels);
var _wanakana = require("wanakana");
const mapping = function() {
    ...
    for(let i = 0; i < chunks.length; i++){
        ...
        for(let j = 0; j < chunkSize; j++)(mapping[chunk[j]] = mapping[chunk[j]] || []).push(chunks[0][j]);
    }
    mapping["ゃ"] = [
        "あ"
    ];
...
function insert(s, i, t) {
    if (i > 0) return s.substring(0, i) + t + s.substring(i, s.length);
    return t + s;
}
function matchingVowel(c, v) {
    const vowels = mapping[c];
    if (vowels) return vowels.some((x)=>v === x);
    return false;
}
class FuzzyVowels {
    constructor(){
    ...
    getCandidates(raw) {
        ...
        for(let i = 0; i < raw.length; i++){
            ...
            if (matchingVowel(c, n)) {
                const candidate = {
                    type: "fuzzy",
                    data: removeCharAt(raw, i + 1)
                };
                candidates.push(candidate);
            } else {
                const vowels = mapping[c] || [];
                for (const v of vowels)if (v !== c) {
                    const candidate = {
                        type: "fuzzy",
                        data: insert(raw, i + 1, v)
                    };
                    candidates.push(candidate);
                }
            }
...
},{"wanakana":"ewinz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eJg4y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MultipleWords", ()=>MultipleWords);
var _wanakana = require("wanakana");
// TODO: create dictionary class and move this there
function lookup(dictionary, s) {
    const result = dictionary[s];
...
class MultipleWords {
    ...
    getCandidates(raw) {
        ...
        if (!(0, _wanakana.isJapanese)(nospaces)) return [];
        const candidates = [];
        if (raw.includes(" ")) {
            const parts = raw.split(" ").filter((x)=>x.length > 0);
            const readings = parts.map((part)=>{
                const hiragana = (0, _wanakana.toHiragana)(part);
                const entries = lookup(this.dictionary, hiragana);
                const rs = getReadings(entries);
...
},{"wanakana":"ewinz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ejBbU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Numerals", ()=>Numerals);
var _kansuji = require("kansuji");
var _kansujiDefault = parcelHelpers.interopDefault(_kansuji);
class Numerals {
    constructor(){
        this.order = 0;
    }
    getCandidates(raw) {
        ...
        if (!match) return [];
        const part = match[0];
        const converted = (0, _kansujiDefault.default)(part);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","kansuji":"ftCcm"}],"ftCcm":[function(require,module,exports) {
"use strict";
module.exports = kansuji;
kansuji.KANJI_DIGITS = [
    "〇",
    "一",
    "二",
    "三",
...
kansuji.DAIJI_UNITS = [
    "拾"
].concat(kansuji.KANJI_UNITS.slice(1));
kansuji.OLD_DAIJI_DIGITS = [
    "零",
    "壱",
    "弐",
    "参",
...
kansuji.OLD_DAIJI_UNITS = [
    "拾",
    "佰",
    "阡",
    "萬"
].concat(kansuji.KANJI_UNITS.slice(4));
kansuji.DOT = "・";
kansuji.PLUS = "＋";
kansuji.MINUS = "−";
...
function kansuji(n, options) {
    ...
    if (!matched) throw new TypeError("Non-number string can't be converted");
    ...
    function buildIchiDict() {
        if (ichi instanceof Array) return [
            false,
            ichi.indexOf(10) !== -1,
            ichi.indexOf(100) !== -1,
            ichi.indexOf(1000) !== -1
    ...
    function convert(str, isDecimal) {
        ...
        for(var i = str.length - 1; i >= 0; i--){
            ...
            if (code >= 0xFF10 && code <= 0xFF19) // Wide number to ASCII
            code -= 65248;
            if (code === 0x30) {
                // "0"
                if (!unit || isDecimal && out.length !== 0) out.unshift(kanjiDigits[0]);
                keta++;
            } else {
                // "1" - "9"
                if (unit && !isDecimal) {
                    ...
                    } else if (r === 0 && keta !== 0) out.unshift(kanjiUnits[keta / 4 + 2] || "");
                }
                out.unshift(kanjiDigits[code - 0x30]);
                keta++;
            }
        }
        if (out.length === 0 && !isDecimal) out.push(kanjiDigits[0]);
        return out.join("");
    }
}
